---
layout: post
title: More SqlDelight (Modules Supporting Extensions With PostgreSql).md
category: blog
...
(*) Limited PostGis support already exists in the core PostgreSql Dialect, this could be moved to a module in the future to make maintenance 
...
When implementing grammar in a new module, overriding parent rules must be performed manually due to limitions in the SqlDelight GrammerKit Composer project https://github.com/sqldelight/Grammar-Kit-Composer
