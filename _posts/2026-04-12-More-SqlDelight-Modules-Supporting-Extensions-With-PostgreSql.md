...
You maybe using SqlDelight already and need a dialect to support some extra functions and types.

Extending the existing SqlDelight PostgreSql dialect is possible using a custom `module` to implement popular PostgreSql extensions for examples see [AWS Postgresql Extensions](https://docs.aws.amazon.com/AmazonRDS/latest/PostgreSQLReleaseNotes/postgresql-extensions.html).
