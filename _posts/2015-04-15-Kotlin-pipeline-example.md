...
An example using [Kotlin](http://kotlinlang.org), as at version 0.12.613, to show a "functional" pipeline that transforms the input text   resulting in a Map associating the character to its occurrence.
